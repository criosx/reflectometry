...
#define PROTDEUT 2.784e-6
#define PROTNONDEUT 1.717e-6
...
fitinfo* setup_models(int *models)
{
    ...
    *models = MODELS;
    ...
    fit_data(&fit[0],"sy060.refl"); /*neat */
    fit_data(&fit[1],"sy061.refl");
    fit_data(&fit[2],"sy067.refl"); //
    fit_data(&fit[3],"sy068.refl"); //second incubation
   ...
   _MM_SET_EXCEPTION_MASK(_MM_GET_EXCEPTION_MASK() & ~_MM_MASK_INVALID);
    ...
    pars_add(pars, "vf_on1", &(vf_on[1]), -0.04, 0.1);
    ...
    pars_add(pars, "thetaoffset0", &(thetaoffset), -0.01, 0.02);
