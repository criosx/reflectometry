...
protected:
    ...
    virtual double fnGetSplineIntegral(double dz1, double dz2, double dp[], double dh[], int damping);
    virtual double fnGetSplineProductIntegral(double dz1, double dz2, double dp[], double dh1[], double dh2[], int damping1, int damping2);
...
class BLM_POPC_POPE_PIP_chol: public BLM_quaternary
{
public:
...
class ssBLM_d13DMPC: public ssBLM
{
public:
    ssBLM_d13DMPC();
    virtual ~ssBLM_d13DMPC() {};
};
...
class ssBLM_d54DMPC_chol: public ssBLM_quaternary
{
public:
    ssBLM_d54DMPC_chol();
    virtual ~ssBLM_d54DMPC_chol() {};
};

class ssBLM_d13DMPC_chol: public ssBLM_quaternary
{
public:
    ssBLM_d13DMPC_chol();
    virtual ~ssBLM_d13DMPC_chol() {};
};
...
class tBLM_HC18_d31POPC_POPS: public tBLM_quaternary_chol
{
public:
...
class tBLM_HC18_POPC_POPS_PIP_CHOL: public tBLM_quaternary_chol
{
public:
